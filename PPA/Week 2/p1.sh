# Create a file documents.txt containing all the possible file names in the format 
# file_XYZ.txt where X is a lower case alphabet, 
# Y is also a lower case alphabet and Z is a number between 0 and 4. 
